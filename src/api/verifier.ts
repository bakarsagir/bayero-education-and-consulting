...
export class UniversityVerifier {
  ...
  private static checkMetaTags($: cheerio.Root) {
    let score = 0;
    const reasons: string[] = [];
  ...
  private static checkKeywords($: cheerio.Root) {
    let score = 0;
    const reasons: string[] = [];
  ...
  private static checkPageStructure($: cheerio.Root) {
    let score = 0;
    const reasons: string[] = [];
  ...
  private static checkAccreditation($: cheerio.Root) {
    let score = 0;
    const reasons: string[] = [];
